                ...
                const demoGroups = [
                  ...
                  },
                  {
                    ...
                    items: [
                      ...
                      { label: 'Trellix', desc: 'Trellix Network Security (IPS/NDR)', type: NODE_TYPES.TOOL, icon: PacketToolIcon, initial: { configType: CONFIG_TYPES.PACKET_TOOL, toolName: 'Trellix', expectedType: 'packet', ingestLimitMbps: DEFAULT_TOOL_INGEST_LIMITS_MBPS['Trellix'] } },
                      { label: 'Cisco', desc: 'Cisco Secure Network Analytics', type: NODE_TYPES.TOOL, icon: PacketToolIcon, initial: { configType: CONFIG_TYPES.PACKET_TOOL, toolName: 'Cisco Secure Network Analytics', expectedType: 'packet', ingestLimitMbps: DEFAULT_TOOL_INGEST_LIMITS_MBPS['Cisco Secure Network Analytics'] } },
                      { label: 'Arista NDR', desc: 'Arista NDR (Awake)', type: NODE_TYPES.TOOL, icon: PacketToolIcon, initial: { configType: CONFIG_TYPES.PACKET_TOOL, toolName: 'Arista NDR', expectedType: 'packet', ingestLimitMbps: DEFAULT_TOOL_INGEST_LIMITS_MBPS['Arista NDR'] } },
                      { label: 'FortiNDR', desc: 'Fortinet FortiNDR', type: NODE_TYPES.TOOL, icon: PacketToolIcon, initial: { configType: CONFIG_TYPES.PACKET_TOOL, toolName: 'FortiNDR', expectedType: 'packet', ingestLimitMbps: DEFAULT_TOOL_INGEST_LIMITS_MBPS['FortiNDR'] } },
                      { label: 'NetWitness', desc: 'NetWitness NDR', type: NODE_TYPES.TOOL, icon: PacketToolIcon, initial: { configType: CONFIG_TYPES.PACKET_TOOL, toolName: 'NetWitness', expectedType: 'packet', ingestLimitMbps: DEFAULT_TOOL_INGEST_LIMITS_MBPS['NetWitness'] } },
                      { label: 'Trend Micro', desc: 'Trend Micro Deep Discovery Inspector', type: NODE_TYPES.TOOL, icon: PacketToolIcon, initial: { configType: CONFIG_TYPES.PACKET_TOOL, toolName: 'Trend Micro', expectedType: 'packet', ingestLimitMbps: DEFAULT_TOOL_INGEST_LIMITS_MBPS['Trend Micro'] } },
                      ...packetCustom
                    ]
                  },
                  {
