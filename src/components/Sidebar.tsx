...
const appsList = [
  ...
  },
  {
    label: 'IP FlowVUE',
    type: NODE_TYPES.GIGASMART,
    tooltip: 'Subscriber-aware flow sampling and rate reduction for cellular/IP traffic. Generates FlowVUE licence (SMT-HC3-GEN3-FVU-SW-TM / SMT-HC3-GEN3-FVU).',
    skuBadge: 'FVU',
  ...
  },
  {
    ...
    type: NODE_TYPES.GIGASMART,
    tooltip: 'Stateful GTP-c / GTP-u correlation and subscriber session filtering by IMSI/MSISDN. Generates GTP Max licence (SMT-HC3-GEN3-GTPMAX-SW-TM / SMT-HC3-GEN3-GTPMAX).',
    skuBadge: 'GTP-MAX',
  ...
  },
  {
    ...
    type: NODE_TYPES.GIGASMART,
    tooltip: 'Prioritised pass-through of specific subscriber sessions matching a configured IMSI whitelist. Uses GTP Max (SMT-HC3-GEN3-GTPMAX-SW-TM) and FlowVUE (SMT-HC3-GEN3-FVU-SW-TM).',
    skuBadge: 'GTP+FVU',
  ...
  },
  {
    ...
    type: NODE_TYPES.GIGASMART,
    tooltip: 'Stateful percentage sampling of subscriber sessions across control and user plane. Uses GTP Max (SMT-HC3-GEN3-GTPMAX-SW-TM) and FlowVUE (SMT-HC3-GEN3-FVU-SW-TM).',
    skuBadge: 'GTP+FVU',
                  ...
                  const demoGroups = [
                    ...
                    },
                    {
                      ...
                      items: [
                        ...
                        {
                          label: 'Armis',
                          desc: 'Armis Asset Intelligence & Security Sensor',
                          type: NODE_TYPES.TOOL,
                          icon: PacketToolIcon,
                          initial: {
                            configType: CONFIG_TYPES.PACKET_TOOL,
                            toolName: 'Armis',
                            expectedType: 'packet',
                            ingestLimitMbps: DEFAULT_TOOL_INGEST_LIMITS_MBPS['Armis'],
                          },
                        },
                        {
                          label: 'Trellix',
