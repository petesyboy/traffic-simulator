...
export { default as ProjectNamePromptModal, isUntitledProject } from './ProjectNamePromptModal';
...
export type { ProjectNamePromptModalProps } from './ProjectNamePromptModal';
